...
namespace THLL.GameEditor.LocationDataEditor
{
    public class NodeLine : VisualElement
    {
        ...
        private void OnIntegerFieldValueChanged(ChangeEvent<int> evt)
        {
            ...
            {
                //变更通行时间
                StartNode.TargetData.Editor_SetConnDistance(EndNode.TargetData, evt.newValue);
                EndNode.TargetData.Editor_SetConnDistance(StartNode.TargetData, evt.newValue);
